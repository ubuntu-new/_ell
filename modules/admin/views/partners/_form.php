...
<div class="items-form">
    ...
    <?= $form->field($model, 'title')->textInput(['maxlength' => true])->hint('Please enter Titile') ?>
    <?= $form->field($model, 'description')->textarea(['rows' => 6]) ?>
    <?= $form->field($model, 'title_ge')->textInput(['maxlength' => true])->hint('Please enter Titile_ge') ?>
    <?= $form->field($model, 'description_ge')->textarea(['rows' => 6]) ?>
    <?= $form->field($model, 'img')->fileInput() ?>
    <?= Html::img(Yii::getAlias('@web').'/uploads/partners/'.$img, ['alt'=>'ell', 'class'=>'thing', 'height'=>'150px', 'width'=>'150px'])?>
    <?= $form->field($model, 'item_key')->textInput(['maxlength' => true, 'value' => 'PARTNERS'])->hint('Don\'t change') ?>
