...
/**
 * partnersSearch represents the model behind the search form of `app\modules\admin\models\Items`.
 */
class partnersSearch extends Items
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Items::find()->where(['item_key' => 'PARTNERS']);
