...
/**
 * studentsSearch represents the model behind the search form of `app\modules\admin\models\Items`.
 */
class studentsSearch extends Items
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Items::find()->where(['item_key' => 'STUDENTS']);
