...
use app\modules\admin\models\PartnerstxtSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PartnerstxtController implements the CRUD actions for Partners model.
 */
class PartnerstxtController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new PartnerstxtSearch();
